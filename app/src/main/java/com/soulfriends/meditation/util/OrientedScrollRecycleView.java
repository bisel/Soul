...
public class OrientedScrollRecycleView extends RecyclerView {

    private float lastX = 0.0f;
    private float lastY = 0.0f;
    private boolean scrolling = false;

    public OrientedScrollRecycleView(@NonNull Context context) {
        this(context, null);
    }

    public OrientedScrollRecycleView(@NonNull Context context, @Nullable AttributeSet attrs) {
